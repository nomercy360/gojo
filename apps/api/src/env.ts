...
const schema = z.object({
  ...
  // to build Telegram login links. Behind Caddy the API lives under
  // `${PUBLIC_APP_URL}/api/*`. Defaults to WEB_ORIGIN; override for a tunnel
  // when testing login_url buttons locally.
